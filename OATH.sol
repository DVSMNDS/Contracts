...
contract OATH is ERC721Enumerable, ReentrancyGuard, DefaultOperatorFilterer, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 700 700"><style>.base { fill: #F34CA5; font-family: Roboto; font-size: 36px; font-weight: bold; text-anchor: middle;}</style><rect width="100%" height="100%" fill="#000" /><text transform="translate(60.000000,600.000000)" fill="#9e9e9e" font-size="700" font-family="Roboto" ><tspan x="0" y="0">&#x3A9;</tspan></text><text x="85" y="510" class="base">';
