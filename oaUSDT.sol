...
// and is not intended for trading or swapping. The token is designed to function similarly to a synthetic asset,
// replicating, or attempting to replicate, the cash flows incident to ownership of USDT,
// with a parity of 1 oaUSDT equaling 1 USDT. This parity is a fixed and unchangeable feature of this ERC20 token.
...
contract oaUSDT is ERC20, ERC20Burnable, Pausable, Ownable, ERC20FlashMint {
    constructor() ERC20("oaUSDT", "oaUSDT") {}
